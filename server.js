...
function ensureData() {
  ...
  if (!fs.existsSync(STORE_FILE)) {
    const seed = {
      ...
      plans: [
        { id: "plan_7d", productId: "prod_delta", name: "7 DAYS", price: 149, active: true },
        { id: "plan_30d", productId: "prod_delta", name: "30 DAYS", price: 399, active: true },
...
app.post("/api/orders/:orderId/demo-pay", (req, res) => {
  ...
  if (available.length < order.quantity) return res.status(409).json({ error: "Inventory changed; please create a new order." });
